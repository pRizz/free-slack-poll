...
- If that happens, inspect the browser console and current page state for the underlying workspace URL, then explicitly navigate to `https://brightbuildsllc.slack.com/`; that URL should work with the logged-in session.
